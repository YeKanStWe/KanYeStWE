...
public class Venda implements Persistente {
    ...
    public enum Status {
        ...
        public static domain.Venda.Status getByName(String value) {
            for (domain.Venda.Status status : domain.Venda.Status.values()) {
    ...
    private domain.Venda.Status status;
    ...
    private void validarStatus() {
        if (this.status == domain.Venda.Status.CONCLUIDA) {
    ...
    public domain.Venda.Status getStatus() {
        return status;
    }

    public void setStatus(domain.Venda.Status status) {
        this.status = status;
    }
